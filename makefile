...
_DEPS = KmerGraph.h KmerMatcher.h MatchGroup.h UnitigGraph.h GraphCleaner.h AlnHaploFilter.h GraphPhaser.h Common.h GraphResolver.h AnchorFinder.h UnionFind.h ChunkmerFilter.h
DEPS = $(patsubst %, $(SRCDIR)/%, $(_DEPS))

_OBJ = KmerGraph.o KmerMatcher.o UnitigGraph.o GraphCleaner.o AlnHaploFilter.o GraphPhaser.o Common.o GraphResolver.o AnchorFinder.o UnionFind.o ChunkmerFilter.o
