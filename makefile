...
_OBJ = Common.o UnionFind.o TwobitString.o SparseEdgeContainer.o RankBitvector.o ChunkGraphWriter.o ChunkUnitigGraph.o EdlibWrapper.o ConsensusMaker.o KmerIterator.o GraphCleaner.o SequenceHelper.o ChunkExtractor.o SequenceIdentitySplitter.o ChunkPhasing.o ChunkResolution.o CanonHelper.o OverlapMatcher.o PathWalker.o TransitiveClosure.o
